...
import com.uber.ClientSocketService.producers.KafkaProducerService;
...
public class DriverRequestController {
    ...
    @GetMapping
    public Boolean help() {
        kafkaProducerService.publishMessage("driverResponse-topic", "Hello World");
        return true;
    }
    ...
    public synchronized void rideResponse(@DestinationVariable Long passengerId, @Payload RideResponseDTO responseDTO) {
...
//        System.out.println(updateBookingResponseDTO);
        ...
        kafkaProducerService.publishMessage("driverResponse-topic", "Driver with id: " +  responseDTO.getDriverId() + " accepted the request");
